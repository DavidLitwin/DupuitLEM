#!/bin/bash
#SBATCH --job-name=vary_k_d_stoch
#SBATCH --time=36:0:0
...
cp ~/data/dlitwin3/DupuitLEMScripts/run_stochastic_recharge/vary_k_d_9vals.py ~/data/dlitwin3/DupuitLEMResults/vary_k_d_9vals_stoch-$SLURM_ARRAY_TASK_ID
