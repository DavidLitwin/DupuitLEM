...
paths = glob.glob('../DupuitLEMResults/vary_Ksat_2*')
...
for i in range(len(paths)):
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/elev_'+str(ID) +'.png')
    plt.close()
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/soil_'+str(ID) +'.png')
    plt.close()

    # relative saturation
    plt.figure(figsize=(8,6))
    imshow_grid(grid,(wt-base)/(elev-base), cmap='Blues', limits=(0,1), colorbar_label = 'Relative saturated thickness [-]', grid_units=('m','m'))
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/rel_thickness_'+str(ID) +'.png')
    plt.close()
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/surface_water_'+str(ID) +'.png')
    plt.close()
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/cross_section_'+str(ID) +'.png')
    plt.close()
    ...
    plt.legend()
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/log_rel_change_'+str(ID)+'.png')
    plt.close()
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/recession_time_'+str(ID) +'.png')
    plt.close()
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/recession_channels_'+str(ID) +'.png')
    plt.close()
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/recession_plot_'+str(ID) +'.png', bbox_inches = 'tight')
    plt.close()
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/steady_channels_'+str(ID) +'.png')
    plt.close()
    ...
    plt.savefig('../DupuitLEMResults/figs/vary_Ksat_2/min_channels_'+str(ID) +'.png')
    plt.close()
...
pickle.dump(df,open('../DupuitLEMResults/figs/vary_Ksat_2/data_processed.p','wb'))
