...
THIS SCRIPT INTENTIONALLY KEEPS KSAT AND B CONSTANT ACROSS MODEL RUNS, FOR COMPARISON TO COEVOLVED MODEL RUNS.
"""
...
b = 8.00 #df_params['b'] #characteristic depth  [m] # median of stoch_LHS_1
...
try:
    ...
    ksat_type = None
    ksat = 1.19e-6 #df_params['ksat'] # median of stoch_LHS_1
