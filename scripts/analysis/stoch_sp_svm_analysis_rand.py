...
THIS SCRIPT INTENTIONALLY USES A RANDOMLY SELECTED GRID FROM THE SAME BASE_OUTPUT_FOLDER, FOR COMPARISON TO COEVOLVED MODEL RUNS.
"""
...
b = df_params['b'] #characteristic depth  [m] # median of stoch_LHS_1
...
try:
    ...
    ksat_type = None
    ksat = df_params['ksat'] # median of stoch_LHS_1
