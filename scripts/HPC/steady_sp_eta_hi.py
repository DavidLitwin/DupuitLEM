...
def generate_parameters(p, n, v0, hg, lg, tg, eta, hi):
    ...
    return K, D, U, ksat, p, b, n, v0, hg, lg, tg, eta, hi
...
for i in range(len(hi1)):
    params[i,:] = generate_parameters(p1, n1, v0, hg, lg, tg, eta1[i], hi1[i])
df_params = pandas.DataFrame(params,columns=['K', 'D', 'U', 'ksat', 'p', 'b', 'n', 'v0', 'hg', 'lg', 'tg', 'eta', 'hi'])
...
output["base_output_path"] = './data/steady_sp_eta_hi_'
