...
def generate_parameters(p, n, v0, hg, lg, tg, gam, hi, sigma, rho, ai):
    ...
    return K, D, U, ksat, p, pet, b, n, v0, hg, lg, tg, ds, tr, tb, gam, hi, sigma, rho, ai
...
for i in range(len(sigma1)):
    params[i,:] = generate_parameters(p, n, v0, hg, lg, tg, gam1[i], hi, sigma1[i], rho, ai)

df_params = pandas.DataFrame(params,columns=['K', 'D', 'U', 'ksat', 'p', 'pet', 'b', 'n', 'v0', 'hg', 'lg', 'tg', 'ds', 'tr', 'tb', 'gam', 'hi', 'sigma', 'rho', 'ai'])
