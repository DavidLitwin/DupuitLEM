...
gam = 5.0 # drainage capacity index
...
rot = np.array([0, 15, 30, 45, 60, 75, 90])*np.pi/180 #rotation angle between grid axes and princpal axes of anisotropy
...
params = np.array(generate_parameters(p1, n1, v0, hg, lg, tg, gam, hi)).reshape(1,13)
