...
in Litwin et al. 2021. Vary Hi and gamma, include an incision threshold E0,
...
def generate_parameters(p, n, v0, hg, lg, tg, gam, hi, theta):
    ...
    return K, D, U, ksat, p, b, n, v0, hg, lg, tg, E0, gam, hi, theta
...
params = np.zeros((len(hi1),15))
for i in range(len(hi1)):
    params[i,:] = generate_parameters(p1, n1, v0, hg, lg, tg, gam1[i], hi1[i], theta)
df_params = pandas.DataFrame(params,columns=['K', 'D', 'U', 'ksat', 'p', 'b', 'n', 'v0', 'hg', 'lg', 'tg', 'E0', 'gam', 'hi', 'theta'])
